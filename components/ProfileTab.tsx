...
import { Camera, MapPin, DollarSign, Star, Shield, Globe, Award, Clock, ChevronRight, LogOut, Settings, Edit3, Phone, Mail, FolderOpen, Plus, Trash2, AlertTriangle, CheckCircle2, X, Link2, Copy, Check, Zap, Heart, ThumbsUp } from 'lucide-react'
...
export const ProfileTab: React.FC<ProfileTabProps> = ({ profile, documents, onLogout, onUpdateProfile, onDocumentsChange }) => {
  ...
  const handleAddDocument = () => {
    ...
    addDocument({
      name: docName.trim(),
      type: docType as CaregiverDocument['type'],
